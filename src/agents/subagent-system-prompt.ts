...
export function buildSubagentSystemPrompt(params: {
  ...
  if (canSpawn) {
    lines.push(
      ...
      "If a child completion event arrives AFTER you already sent your final answer, reply ONLY with NO_REPLY. This does not apply to a direct `sessions_send` result you just requested; use that inline result to continue and deliver the user/source reply when appropriate.",
