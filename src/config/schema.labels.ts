...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "talk.realtime.allowImageInput": "Talk Realtime Allow Image Input",
  "talk.realtime.persistTranscript": "Talk Realtime Persist Transcript",
  "talk.realtime.clientTools": "Talk Realtime Client Tools",
  "talk.realtime.clientTools.*": "Talk Realtime Client Tool",
  "talk.realtime.clientTools.*.name": "Talk Realtime Client Tool Name",
  "talk.realtime.clientTools.*.description": "Talk Realtime Client Tool Description",
  "talk.realtime.clientTools.*.parameters": "Talk Realtime Client Tool Parameters",
  "talk.realtime.gatewayTools": "Talk Realtime Gateway Tools",
  "talk.realtime.gatewayTools.*": "Talk Realtime Gateway Tool",
  "talk.realtime.gatewayTools.*.name": "Talk Realtime Gateway Tool Name",
  "talk.realtime.gatewayTools.*.description": "Talk Realtime Gateway Tool Description",
  "talk.realtime.gatewayTools.*.parameters": "Talk Realtime Gateway Tool Parameters",
  "talk.realtime.gatewayTools.*.exec": "Talk Realtime Gateway Tool Executable",
  "talk.realtime.gatewayTools.*.argKey": "Talk Realtime Gateway Tool Argument Key",
  channels: "Channels",
