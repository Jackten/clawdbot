...
export type TalkRealtimeConfig = {
  ...
  /** Allow authenticated clients to attach bounded JPEGs to Gateway-relayed realtime sessions. */
  allowImageInput?: boolean;
  /** Persist completed non-consult Gateway relay turns into the agent's main session. */
