 ...
 */
// Schema changes are additive (CREATE TABLE IF NOT EXISTS), so a build declaring the current
// version opens both a freshly created database and an already-migrated one.
